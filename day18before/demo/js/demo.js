 /*
  ...
  wx.config({
      debug: false,
	    appId: 'wx40cd76b35fe6dd4a', // 必填，公众号的唯一标识
	    timestamp: '1478061758', // 必填，生成签名的时间戳
	    nonceStr: 'wwwAsa', // 必填，生成签名的随机串
	    signature: 'ccc28418f85dfb14365ca327eb6e8b8cdd0d173a',// 必填，签名
      jsApiList: [
        'checkJsApi',
        'onMenuShareTimeline',
